    ...
    <div class="col-lg">
        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="row">
                    <p class="col-sm-7" style="font-size: 14px;font-style: normal;font-family: Shabnam">در این بخش می
                        توانید مشخصات را تعریف کنید</p>
                    <p class="col-sm-5" style="direction: ltr" @click="more">
                        <i :class="clas"></i><span :class="btnClass">{{save}}</span></p>
                </div>
            </div>
            <div class="box-body" v-show="moreItem">
                <div class="col-lg-12">
                    <div class="col-sm-2">
...
export default {
    data() {
        return {
            moreItem: false,
            btnClass: 'btn-border_green',
            mouseClass: 'mouse-hover',
            save: 'افزودن',
            clas: 'fa fa-fw fa-angle-down',
            cats: [
                {id: 1, name: 'cat1'},
                {id: 2, name: 'cat2'},
                {id: 3, name: 'cat3'},
    ...
    , methods: {
        more() {
            ...
            this.moreItem ? this.save = 'بستن' : this.save = 'افزودن';
            this.moreItem ? this.clas = 'fa fa-fw fa-angle-up' : this.clas = 'fa fa-fw fa-angle-down';
            this.moreItem ? this.btnClass = 'btn-no-border' : this.btnClass = 'btn-border_green';
        }, saveForm() {
